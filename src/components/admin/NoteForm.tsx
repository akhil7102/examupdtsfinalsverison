...
const courses = ['B.Tech', 'B.Pharm', 'M.Tech', 'MBA'];
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg p-4 sm:p-6 border border-gray-200 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => {
                setFormData({ ...formData, course: value, year: undefined });
              }}
            >
            ...
            <p className="text-xs text-[#0A0A0A]/60">
              Optional: Select the course this note belongs to
            </p>
          </div>

          {/* Year Selection - Only show when course is selected */}
          {formData.course && yearsByCourse[formData.course] && (
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  {yearsByCourse[formData.course].map((year) => (
              ...
              <p className="text-xs text-[#0A0A0A]/60">
                Optional: Select the year within {formData.course}
              </p>
            </div>
          )}
