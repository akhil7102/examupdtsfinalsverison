            ...
            <table className="w-full">
              <thead className="bg-[#F5F5F5] border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-[#0A0A0A]/60 uppercase">Course</th>
                  <th className="px-4 py-3 text-left text-[#0A0A0A]/60 uppercase">Year</th>
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <span className="text-[#0A0A0A]/60 text-xs">{note.fileType}</span>
                      </div>
                      <p className="text-[#0A0A0A]/60 text-xs">{formatDate(note.uploadDate)}</p>
                    </div>
                  </div>
